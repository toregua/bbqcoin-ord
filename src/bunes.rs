...
pub use {edict::Edict, bune::Bune, bune_id::BuneId, bunestone::Bunestone, terms::Terms};

pub(crate) use {etching::Etching, pile::Pile, spaced_bune::SpacedBune};
...
mod tests {
  ...
  #[test]
  fn index_starts_with_no_bunes() {
    let context = Context::builder().arg("--index-bunes").build();
    context.assert_bunes([], []);
  }

  #[test]
  fn default_index_does_not_index_bunes() {
  ...
  #[test]
  fn empty_bunestone_does_not_create_bune() {
    let context = Context::builder().arg("--index-bunes").build();
    ...
    context.rpc_server.broadcast_tx(TransactionTemplate {
      inputs: &[(1, 0, 0, Witness::new())],
      op_return: Some(Bunestone::default().encipher()),
      ..Default::default()
    });
  ...
  #[test]
  fn etching_with_no_edicts_creates_bune() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn etching_with_edict_creates_bune() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn bunes_must_be_greater_than_or_equal_to_minimum_for_height() {
    {
      let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn etching_with_non_zero_divisibility_and_bune() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn input_bunes_may_be_allocated() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn etched_bune_is_burned_if_an_unrecognized_even_tag_is_encountered() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn input_bunes_are_burned_if_an_unrecognized_even_tag_is_encountered() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn unallocated_bunes_are_assigned_to_first_non_op_return_output() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn unallocated_bunes_in_transactions_with_no_bunestone_are_assigned_to_first_non_op_return_output(
  ) {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn duplicate_bunes_are_forbidden() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn outpoint_may_hold_multiple_bunes() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn multiple_input_bunes_on_the_same_input_may_be_allocated() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn multiple_input_bunes_on_different_inputs_may_be_allocated() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn unallocated_bunes_are_assigned_to_first_non_op_return_output_when_op_return_is_not_last_output(
  ) {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn bune_rarity_is_assigned_correctly() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn edicts_which_refer_to_input_bune_with_no_balance_are_skipped() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn edicts_may_transfer_bunes_to_op_return_outputs() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn outputs_with_no_bunes_have_no_balance() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn edicts_which_transfer_no_bunes_to_output_create_no_balance_entry() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn allocate_all_remaining_bunes_in_etching() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn allocate_all_remaining_bunes_in_inputs() {
    let context = Context::builder().arg("--index-bunes").build();
  ...
  #[test]
  fn bunes_can_be_etched_and_claimed_in_the_same_transaction() {
    let context = Context::builder().arg("--index-bunes").build();
