...
impl BuneEntry {
  pub(crate) fn spaced_bune(&self) -> SpacedBune {
    SpacedBune {
      bune: self.bune,
...
impl Entry for BuneEntry {
  type Value = BuneEntryValue;
  fn load(
    (
      block,
      burned,
...
pub(super) type BuneIdValue = (u64, u32);

impl Entry for BuneId {
  type Value = BuneIdValue;
...
pub(super) type BuneAddressBalance = (u128, u128);
