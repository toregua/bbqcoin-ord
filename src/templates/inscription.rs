...
pub(crate) struct InscriptionHtml {
  ...
  pub(crate) bune: Option<SpacedBune>,
...
pub(crate) struct BbqscriptionJson {
  pub(crate) chain: Chain,
  pub(crate) genesis_fee: u64,
  pub(crate) genesis_height: u32,
  pub(crate) inscription: Inscription,
...
impl PageContent for InscriptionHtml {
  fn title(&self) -> String {
    format!("Bbqscription {}", self.inscription_number)
  }
  ...
  fn with_prev_and_next() {
    assert_regex_match!(
      ...
      "
        <h1>Bbqscription 1</h1>
        <div class=inscription>
        <a class=prev href=/bbqscription/1{64}i1>❮</a>
        <iframe .* src=/preview/2{64}i2></iframe>
        <a class=next href=/bbqscription/3{64}i3>❯</a>
        </div>
        .*
      "
      .unindent()
